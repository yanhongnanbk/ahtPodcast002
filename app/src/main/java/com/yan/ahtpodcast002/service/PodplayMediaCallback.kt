...
class PodplayMediaCallback(
    ...
    //    Helper method to set the current state on the media session.
    private fun setState(state: Int) {
        var position: Long = -1
        mediaPlayer?.let { position = it.currentPosition.toLong() }
...
// 1    The audioManager system service is obtained
